...
public class bmiactivity extends AppCompatActivity {
    ...
    TextView mbmidispaly, mbmicategory, mgender;
    Intent intent;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mbmidispaly = findViewById(R.id.bmidisplay);
        ...
        if(intbmi<16){
            mbmicategory.setText("Very Severe Underweight");
        ...
        Solution.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(bmiactivity.this, solutionChart.class);
                startActivity(intent);
